...
use super::{error_display::show_if_error, StatefulWidget, StagingOpt, StagingString};
...
impl Default for StagingAuthor2{
    fn default() -> Self {
        Self{
            ...
            parsed: Err(Author2ParsingError::MissingField { field_name: "Name".to_owned() }) //FIXME: what?
        }
    }
}
